...
export function PrivacyContent() {
    return (
        ...
        >
            <p><strong>Titolare del trattamento:</strong> ANT SRL ("Titolare") – Società della Rete RAD. P.IVA 03860890965. Sede: Corso Buenos Aires, 47 (MI). Contatti: <a href="mailto:info@antsrl.com">info@antsrl.com</a> – Tel: +39 02 29013496.</p>
            ...
            <p><strong>Revoca consenso / esercizio diritti:</strong> scrivendo a <a href="mailto:info@antsrl.com">info@antsrl.com</a> o tramite link di disiscrizione presente nelle comunicazioni.</p>
